...
var ahmadAzzam = {
    ...
    age : 26,
    dob : 4/12/1993,
    favoriteFood : ['Maqloba', 'mansaf', 'maftool'],
    favoriteMovie : ['interSteller', 'king of the king', 'lucy', 'Alrysallah', 'cast a way'], 
}
...
averageAge = sumAge / persons.length;
